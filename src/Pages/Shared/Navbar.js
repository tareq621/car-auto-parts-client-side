...
const Navbar = () => {
    ...
    const menubar = <>
        ...
        <li><Link to="/signup" className="hover:text-white font-bold">Register</Link></li>

        {
            user
                ?
                <li><button className="font-bold hover:text-white" onClick={logout}>Sign Out</button></li>
                :
                <li><Link to="/login" className="font-bold mr-5">Login</Link></li>}
    </>
    return (
